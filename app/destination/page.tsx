...
const Destination = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center overflow-y-auto ">
      ...
      <div className="outline outline-1 outline-green-300 xl:-ml-[90px] xl:flex xl:gap-40 xl:pt-16">
        ...
        <div className="flex flex-col items-center outline outline-1 outline-yellow-100 xl:max-w-[445px] xl:items-start">
          {/* tabs titles*/}
          ...
          {destinations.map(
            (destination) =>
              activeTab === destination.name && (
                ...
                >
                  <h2 className="pt-5 xl:pt-10 font-bellefair text-[56px] uppercase leading-[64px] text-white  md:text-[80px] md:leading-[92px] xl:text-[100px] xl:leading-[115px]">
                    {destination.name}
                  </h2>
                  <p className="text-center font-barlow text-[15px] leading-[25px] text-[#D0D6F9] md:px-[78px] md:pt-[10px] md:text-base md:leading-7 xl:px-0 xl:text-left xl:text-lg xl:leading-8">
