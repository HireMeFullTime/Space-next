...
const TechnologyCarousel: React.FC = () => {
  ...
  return (
    <section className="embla relative  w-full pt-8 text-white md:pt-[60px] xl:max-h-[560px] xl:pl-[160px] xl:pt-[26px] ">
      ...
      <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-[calc(50%+5px)] justify-center gap-4 md:translate-y-[calc(50%+14px)] xl:left-0 xl:top-0 xl:translate-x-0 xl:translate-y-[calc(50%-30px)] xl:flex-col xl:gap-8">
